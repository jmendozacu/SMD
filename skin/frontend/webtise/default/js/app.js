...
$j(document).ready(function() {
    // trigger slick slider for cross sell and up sell
    $j('.box-up-sell ul, .block-related ul').slick({
    ...
    if($j('.catalog-category-view .col-main .category-title').length) {

        $j('.catalog-category-view .col-main .category-title').detach().prependTo('.col-left-first.sidebar');
...
$j(document).ready(function() {
    $j('.toggle-tabs li').on("click", function(){
