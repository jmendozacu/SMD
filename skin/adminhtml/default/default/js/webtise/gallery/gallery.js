/**
 * Created by joshcarter on 24/06/2016.
 * @category    Webtise
 * @package     Webtise_Gallery
 */

var Gallery = {};

Gallery.Gallery = Class.create();
Gallery.Gallery.prototype = {
    ...
    updateImage : function(file) {
        ...
        this.images[index].image_specific_url = this
            .getFileElement(file, 'cell-image-specific-url input').value;
        this.images[index].tag_ids = this
            .getFileElement(file, 'cell-image-tag-ids input').value;
