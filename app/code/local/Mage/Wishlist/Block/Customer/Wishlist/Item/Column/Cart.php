...
class Mage_Wishlist_Block_Customer_Wishlist_Item_Column_Cart extends Mage_Wishlist_Block_Customer_Wishlist_Item_Column
{
    ...
    {
        $js = "
            function addWItemToCart(obj, itemId) {
                ...
                var advices = '<div class=\"validation-advice\" style=\"white-space: normal;word-wrap: break-word;\">#</div>';
                jQuery.ajax({
                    type: 'GET',
                    url: url,
                    cache: false,
                    ...
                    success: function(databack) {
                        ...
                        if (databack.status == 'success') {
                            ...
                            jQuery(obj).parent().append(advices.replace('#', databack.message));
                        }
                    }
