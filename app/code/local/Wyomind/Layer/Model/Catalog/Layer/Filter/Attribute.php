 ...
 */
class Wyomind_Layer_Model_Catalog_Layer_Filter_Attribute extends Mage_Catalog_Model_Layer_Filter_Attribute
{
    /**
     * @var string
     */
     ...
     * @return Wyomind_Layer_Model_Catalog_Layer_Filter_Attribute
     */
