 ...
 */
class Wyomind_Layer_Model_Catalog_Layer_Filter_Category extends Mage_Catalog_Model_Layer_Filter_Category
{
    /**
     * @var array
     */
    ...
    public function apply(Zend_Controller_Request_Abstract $request, $filterBlock)
    {
        ...
        $categoryIds = explode(Wyomind_Layer_Helper_Data::OPTIONS_SEPARATOR, $param);
        if (!empty($categoryIds)) {
            ...
            Mage::register('layer_applied_category_ids', $this->_appliedCategoryIds, true);
        }
    ...
    {
        if ($this->_helper()->isCategoryTreeEnabled()) {
            return 1; // workaround to force category tree to be shown even if current category does not have child
        }
