 ...
 */
class Wyomind_Attributeoptionpro_Model_Resource_Catalog_Attribute
            ...
            if (isset($option['value'])) {
                ...
                foreach ($option['value'] as $optionId => $values) {
                    ...
                    foreach ($stores as $store) {
                        if (Mage::helper('attributeoptionpro')->isStoreHidden($store->getId())) {
                            continue;
                        }
                        $where = array(
    ...
    protected function _saveStoreLabels(Mage_Core_Model_Abstract $object)
    {
        ...
        if (is_array($storeLabels)) {
            ...
            foreach ($storeLabels as $storeId => $label) {
                if (Mage::helper('attributeoptionpro')->isStoreHidden($storeId)) {
                    continue;
                }
                if ($object->getId()) {
                    $condition = array(
