...
class Webtise_Gallery_Model_Gallery_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
...
//        print '$this->_getNeedMemoryForBaseFile() = '.$this->_getNeedMemoryForBaseFile();
    ...
    public function setBaseFile($file)
    {
        ...
        $baseDir = Mage::getSingleton('gallery/gallery_media_config')->getBaseMediaPath();
        ...
        if (!$file) {
            ...
            $isConfigPlaceholder = Mage::getStoreConfig("gallery/placeholder/{$this->getDestinationSubdir()}_placeholder");
        ...
        $path = array(
            Mage::getSingleton('gallery/gallery_media_config')->getBaseMediaPath(),
            'cache',
...
//            }
    ...
    {
        $directory = Mage::getBaseDir('media') . DS.'webtise'.DS.'gallery'.DS.'cache'.DS;
