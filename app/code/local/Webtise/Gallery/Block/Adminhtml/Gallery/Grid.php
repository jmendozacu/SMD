...
class Webtise_Gallery_Block_Adminhtml_Gallery_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns(){
        ...
        if ($this->_getStore()->getId()){
            $this->addColumn('gallery_gallery_title', array(
                'header'    => Mage::helper('gallery')->__('Title in %s', $this->_getStore()->getName()),
                'align'     => 'left',
                'index'     => 'gallery_gallery_title',
            ));
        }
        $this->addColumn('created_at', array(
            'header'    => Mage::helper('gallery')->__('Created at'),
            'index'     => 'created_at',
            'width'     => '120px',
            'type'      => 'datetime',
        ));
        $this->addColumn('updated_at', array(
            'header'    => Mage::helper('gallery')->__('Updated at'),
            'index'     => 'updated_at',
            'width'     => '120px',
            'type'      => 'datetime',
        ));
