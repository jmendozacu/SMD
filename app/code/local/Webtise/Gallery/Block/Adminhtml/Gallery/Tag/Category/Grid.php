...
class Webtise_Gallery_Block_Adminhtml_Gallery_Tag_Category_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct(){
        parent::__construct();
        $this->setId('galleryTagCategoryGrid');
    ...
    protected function _prepareCollection(){
        $collection = Mage::getModel('gallery/gallery_tag_category')->getCollection()
            ->addFieldToSelect('*');
    ...
    protected function _prepareMassaction(){
        ...
        $this->getMassactionBlock()->setFormFieldName('gallery_tag_category');
