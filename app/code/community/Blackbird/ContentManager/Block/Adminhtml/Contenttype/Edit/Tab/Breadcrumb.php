...
class Blackbird_ContentManager_Block_Adminhtml_Contenttype_Edit_Tab_Breadcrumb extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('breadcrumb', 'select', array(
            ...
            'required'  => false,
            'options'   => Blackbird_ContentManager_Model_Source_Options_Type::toOptionByContentTypeArray(),
        ));
