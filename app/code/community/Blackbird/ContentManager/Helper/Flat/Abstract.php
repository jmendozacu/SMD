 ...
 */
abstract class Blackbird_ContentManager_Helper_Flat_Abstract extends Mage_Core_Helper_Abstract
{
    /**
     * ContentManager Flat index process code
     *
     * @var null|string
     */
    ...
    /**
     * Store ContentManager Flat index process instance
     *
    ...
    /**
     * Check if ContentManager Flat Data has been initialized
     *
    ...
    /**
     * Check if ContentManager Flat Data is enabled
     *
    ...
    /**
     * Check if ContentManager Flat Data is available
     * without lock check
     *
     * @return bool
     */
    ...
    /**
     * Check if ContentManager Flat Data is available for use
     *
     * @return bool
     */
    ...
    /**
     * Retrieve ContentManager Flat index process
     *
