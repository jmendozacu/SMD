 ...
 */
class Blackbird_ContentManager_Model_Contenttype_Option_Type_File extends Blackbird_ContentManager_Model_Contenttype_Option_Type_Default
{
    /**
     ...
     * @return Blackbird_ContentManager_Model_Product_Option_Type_File
     */
    ...
    protected function _validateUploadedFile()
    {
        ...
        try {
            ...
            if (isset($_SERVER['CONTENT_LENGTH']) && $_SERVER['CONTENT_LENGTH'] > $this->_getUploadMaxFilesize()) {
                ...
                {
                    case Blackbird_ContentManager_Model_ContentType_Type_Abstract::PROCESS_MODE_FULL:
                        Mage::throwException(
    ...
    protected function _validateFile($optionValue)
    {
        $option = $this->getOption();
        /**
         * @see Blackbird_ContentManager_Model_Product_Option_Type_File::_validateUploadFile()
