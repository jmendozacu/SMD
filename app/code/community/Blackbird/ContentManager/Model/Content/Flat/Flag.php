...
/**
 * Calatog Content Flat Flag Model
 *
 * @category   Mage
 * @package    Blackbird_ContentManager
 * @author     Magento Core Team <core@magentocommerce.com>
 */
class Blackbird_ContentManager_Model_Content_Flat_Flag extends Mage_Core_Model_Flag
{
    /**
     * Flag code
     *
     * @var string
     */
    protected $_flagCode = 'contentmanager_content_flat';
     ...
     * @param int  $storeId
     * @param bool $built
     * @return Blackbird_ContentManager_Model_Content_Flat_Flag
     */
    ...
    /**
     * Retrieve ContentManager Content Flat Data is built flag
     *
     * @return bool
     */
    ...
    /**
     * Set ContentManager Content Flat Data is built flag
     *
     * @param bool $flag
     *
     * @return Blackbird_ContentManager_Model_Content_Flat_Flag
     ...
     * Set ContentManager Content Flat Data is built flag
     *
     * @deprecated after 1.7.0.0 use Blackbird_ContentManager_Model_Content_Flat_Flag::setIsBuilt() instead
     *
     * @param bool $flag
     *
     * @return Blackbird_ContentManager_Model_Content_Flat_Flag
