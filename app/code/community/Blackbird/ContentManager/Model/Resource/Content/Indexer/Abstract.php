...
/**
 * ContentManager Content Indexer Abstract Resource Model
 *
 * @category    Mage
 * @package     Blackbird_ContentManager
 * @author      Magento Core Team <core@magentocommerce.com>
 */
abstract class Blackbird_ContentManager_Model_Resource_Content_Indexer_Abstract extends Mage_Index_Model_Resource_Abstract
{
    /**
     * Retrieve contentmanager_content attribute instance by attribute code
     *
    ...
    {
        return Mage::getSingleton('eav/config')->getAttribute(Blackbird_ContentManager_Model_Content::ENTITY, $attributeCode);
    }
     ...
     * @return Blackbird_ContentManager_Model_Resource_Content_Indexer_Abstract
     */
    ...
    /**
     * Retrieve content relations by children
     *
    ...
    public function getRelationsByChild($childIds)
    {
        ...
        $select = $write->select()
            ->from($this->getTable('contentmanager/content_relation'), 'parent_id')
    ...
    /**
     * Retrieve content relations by parents
     *
    ...
    public function getRelationsByParent($parentIds)
    {
        ...
        if (!empty($parentIds)) {
            $write = $this->_getWriteAdapter();
            $select = $write->select()
                ->from($this->getTable('contentmanager/content_relation'), 'child_id')
